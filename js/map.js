function initMap() {
    ...
    var contentMensAcademy = '<div class="info-window">' +
        '<h3 class="text-dark">Mens Academy and Agency</h3>' +
        '<div class="info-content">' +
        '<p class="text-dark">¡Encontraste la mejor agencia de modelos en Latinoamérica!</p>' +
